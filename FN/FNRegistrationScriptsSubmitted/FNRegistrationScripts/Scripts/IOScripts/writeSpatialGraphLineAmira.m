...
function [] = writeSpatialGraphLineAmira(pt1,pt2,outputFilename,neuriteID,EdgePtRadius,axesDirections)

    
    pt2 = ([pt2(1)*axesDirections(1) pt2(2)*axesDirections(2) pt2(3)*axesDirections(3)] );
