...
void AmiraSpatialGraph::addDendriteID( int dendriteID)
{
...
std::vector<int>* AmiraSpatialGraph::getDendriteIDArray( )
{
    return &DendriteIDs;
};
...
int AmiraSpatialGraph::getDendriteCellIndex( int ID)
{
    ...
    for(int i = 0; i < DendriteIDs.size(); i++ )
    {
        if(DendriteIDs.at(i) == ID)
        {
            return i;
        }
    }
