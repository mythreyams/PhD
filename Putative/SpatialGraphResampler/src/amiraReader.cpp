...
//              }
                if(applyTransform)
                {
                    ...
                    inputSpatialGraph->applyInverseTransformation(transformation);
                }
                for(int ii = 0; ii < 4; ++ii)
...
//      NeuroMorphData << "define GRAPH " << /*amira_spatial_graph->vertice_list.size() +*/ /*amira_contour_graph->vertice_list.size() +*/ inputSpatialGraph->getNumberOfVertices() + /*amira_spatial_graph->edge_list.size() +*/ /*amira_contour_graph->edge_list.size() +*/ inputSpatialGraph->getNumberOfEdges() << std::endl;
        ...
        NeuroMorphData << "            Id 4" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "        Cell_1_Dendrite {" << std::endl;
        NeuroMorphData << "            Color 0 1 1," << std::endl;
        NeuroMorphData << "            Id 8" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "        Cell_2_Dendrite {" << std::endl;
        NeuroMorphData << "            Color 0 1 0.196898," << std::endl;
        NeuroMorphData << "            Id 9" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "        Cell_3_Dendrite {" << std::endl;
        NeuroMorphData << "            Color 1 0 0.5," << std::endl;
        NeuroMorphData << "            Id 16" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "        Cell_1_Axon {" << std::endl;
        NeuroMorphData << "            Color 0.936306 0.390127 0.640459," << std::endl;
        NeuroMorphData << "            Id 10" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "        Cell_2_Axon {" << std::endl;
        NeuroMorphData << "            Color 0.5 0 0.5," << std::endl;
        NeuroMorphData << "            Id 11" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "        Cell_3_Axon {" << std::endl;
        NeuroMorphData << "            Color 0.142933 0.414013 0.334948," << std::endl;
        NeuroMorphData << "            Id 13" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "        Cell_1_Soma {" << std::endl;
        NeuroMorphData << "            Color 0 1 1," << std::endl;
        NeuroMorphData << "            Id 14" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "        Cell_2_Soma {" << std::endl;
        NeuroMorphData << "            Color 0 1 0.25," << std::endl;
        NeuroMorphData << "            Id 15" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "        Cell_3_Soma {" << std::endl;
        NeuroMorphData << "            Color 0.5 1 0.625," << std::endl;
        NeuroMorphData << "            Id 17" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "        Color 1 1 1," << std::endl;
        NeuroMorphData << "        Id 0" << std::endl;
        NeuroMorphData << "    }" << std::endl;
        NeuroMorphData << "    SpatialGraphUnitsVertex {" << std::endl;
        NeuroMorphData << "        VertexLabels {" << std::endl;
        NeuroMorphData << "            Unit -1," << std::endl;
        NeuroMorphData << "            Dimension -1" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        ...
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "    }" << std::endl;
        NeuroMorphData << "    SpatialGraphUnitsEdge {" << std::endl;
        NeuroMorphData << "        EdgeLabels {" << std::endl;
        NeuroMorphData << "            Unit -1," << std::endl;
        NeuroMorphData << "            Dimension -1" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        ...
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "    }" << std::endl;
        NeuroMorphData << "    SpatialGraphUnitsPoint {" << std::endl;
        NeuroMorphData << "        thickness {" << std::endl;
        NeuroMorphData << "            Unit -1," << std::endl;
        NeuroMorphData << "            Dimension -1" << std::endl;
        NeuroMorphData << "        }" << std::endl;
        NeuroMorphData << "    }" << std::endl;
        ...
        NeuroMorphData << "POINT { float thickness } @9" << std::endl;
...
void Reader::writeSpatialGraphFile2(const char * header_spatial_graph_filename, AmiraSpatialGraph * given_spatial_graph)
{
    /* This will copy the header of the spatial graph file till @1 tag from the first graph
    * and the rest from the second spatial graph. Useful when only points need to be modified 
    * from an existing spatial graph file                                                    */
    ...
    NeuroMorphData << "define VERTEX " << given_spatial_graph->getNumberOfVertices() << std::endl;
    NeuroMorphData << "define EDGE " << given_spatial_graph->getNumberOfEdges()  << std::endl;
    NeuroMorphData << "define POINT " << given_spatial_graph->getNumberOfPoints() << std::endl;
    NeuroMorphData << std::endl;    
    // copy the header of the other spatial graph
    std::ifstream inputStream(header_spatial_graph_filename);
    std::string currentLine;
    int line_count = 0;
    int loc;
    bool point_copy_state = false;
    double edgePointCoordIndex = 10000000;
    double tempPointCoordIndex = 10000000;
    double pointThicknessIndex = 10000000;
    double numEdgePointsIndex = 1000000;
    
    enum{
        REST_COPY,
        NUM_POINT_PER_EDGE_COPY,
        POINT_COPY,
        POINT_THICKNESS_COPY,
        WAIT
    }COPY_STATE;
    COPY_STATE = REST_COPY;
    if(!inputStream.fail())
    {
            while(!std::getline(inputStream, currentLine).eof())
            {
                line_count++;
                if((currentLine.find("POINT", 0) != std::string::npos)
                    &&(currentLine.find("EdgePointCoordinates", 0) != std::string::npos))
                {
                    NeuroMorphData<< currentLine << std::endl;
                    //std::cout << currentLine << std::endl;
                        loc = currentLine.find("@", 0);
                        char * tmp = new char[currentLine.size() - loc - 1];
                        currentLine.copy(tmp, currentLine.size() - loc - 1, loc + 1);
                ...
                if(((currentLine.find("thickness", 0) != std::string::npos)
                    &&(currentLine.find("POINT", 0) != std::string::npos))
                    ||((currentLine.find("radius", 0) != std::string::npos)
                    &&(currentLine.find("POINT", 0) != std::string::npos)))
                {
                    // find tag for thickness
                     NeuroMorphData<< currentLine << std::endl;
                    //std::cout << currentLine << std::endl;
                        loc = currentLine.find("@", 0);
                        char * tmp = new char[currentLine.size() - loc - 1];
                        currentLine.copy(tmp, currentLine.size() - loc - 1, loc + 1);
                        pointThicknessIndex = atoi(tmp);
                        delete [] tmp;
                        continue;
                 
                }
                if((currentLine.find("NumEdgePoints", 0) != std::string::npos)
                    &&(currentLine.find("EDGE", 0) != std::string::npos))
                ...
                if(currentLine.find("@", 0) == 0)
                {
                        ...
                        char * tmp = new char[currentLine.size() - loc - 1];
                        currentLine.copy(tmp, currentLine.size() - loc - 1, loc + 1);
                        tempPointCoordIndex = atoi(tmp);
                        
                        if(tempPointCoordIndex == numEdgePointsIndex)
                        {
                            // set flag 
                            COPY_STATE = NUM_POINT_PER_EDGE_COPY;
                            NeuroMorphData << currentLine << std::endl;
                            //std::cout<< currentLine << std::endl;
                        }
                        
                        else if(tempPointCoordIndex == edgePointCoordIndex)
                        {
                            // set flag 
                            COPY_STATE = POINT_COPY;
                            NeuroMorphData << currentLine << std::endl;
                            //std::cout<< currentLine << std::endl;
                        }
                        else if(tempPointCoordIndex == pointThicknessIndex)
                        {
                            // reset flag
                            COPY_STATE = POINT_THICKNESS_COPY;
                            NeuroMorphData << currentLine << std::endl;
                ...
                if(COPY_STATE == NUM_POINT_PER_EDGE_COPY)
                {
                    for(edgeIt = given_spatial_graph->edgesBegin(); edgeIt != given_spatial_graph->edgesEnd(); ++edgeIt)
                    {
                ...
                else if(COPY_STATE == POINT_COPY)
                {
                    ...
                    for(edgeIt = given_spatial_graph->edgesBegin(); edgeIt != given_spatial_graph->edgesEnd(); ++edgeIt)
                    {
                            ...
                            for(contour_it = (*edgeIt)->edgePointCoordinates.begin(); contour_it != (*edgeIt)->edgePointCoordinates.end(); ++contour_it)
                            {
                                    NeuroMorphData << std::scientific << std::setprecision( 15 ) << (*contour_it)[X_COORD] << " " << (*contour_it)[Y_COORD] << " " << (*contour_it)[Z_COORD] << std::endl;
                                    
                                    //std::cout << std::scientific << std::setprecision( 14 ) << (*contour_it)[X_COORD] << " " << (*contour_it)[Y_COORD] << " " << (*contour_it)[Z_COORD] << std::endl;
                                    
                            }
                    }
                    COPY_STATE = WAIT;
                }
                else if(COPY_STATE == POINT_THICKNESS_COPY)
                {
                    ...
                    for(edgeIt = given_spatial_graph->edgesBegin(); edgeIt != given_spatial_graph->edgesEnd(); ++edgeIt)
                    {
                            ...
                            for(contour_it = (*edgeIt)->edgePointCoordinates.begin(); contour_it != (*edgeIt)->edgePointCoordinates.end(); ++contour_it)
                            {
                                    NeuroMorphData << std::scientific << std::setprecision( 15 ) << thickness << std::endl;
                                    //std::cout << (*contour_it)[X_COORD] << " " << (*contour_it)[Y_COORD] << " " << (*contour_it)[Z_COORD] << std::endl;
