...
class Reader
{
        public:
                ...
                void writeSpatialGraphFile2(AmiraSpatialGraph *);
                // alternate method for writing Amira SpatialGraph files
                void writeSpatialGraphFileFromEdges();
                void writeSpatialGraphFile2(const char * header_spatial_graph_filename, AmiraSpatialGraph * given_spatial_graph);
