...
//   void writeCoordinateListinAmiraCoords(std::list<double*> listinImageCoords, const char* outputPathname, const char* outputFilename, bool scale, bool translate, bool transform );
