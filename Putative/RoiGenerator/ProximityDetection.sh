...
#   for k in 4;
#   do
OutputName="/home/mythreya/Documents/outputroi/${name}/${cellName}/"
...
mkdir "/home/mythreya/Documents/outputroi/${name}/"
chmod 777 "/home/mythreya/Documents/outputroi/${name}/"
mkdir ${OutputName}
...
do	
    ...
    # 	
	    ...
	    mkdir "${OutputName}/S${i}/Rois"
	    chmod 777 "${OutputName}/S${i}/Rois"
...
tmp=" ${dataName}/$secDir ${i} 0 ${file} ${OutputName}/S${i} ${mergedFilename} ${transformated_file}"
#tmp="${transformated_file} deconvolved_z%03d.png ${OutputName}/S${i}/ProximityDetection/proximity 0 ${file} 1 ${mergedFilename} nondecon%03d.png $noImageTest"
echo ${tmp}
/home/mythreya/projects/RoiGenerator/BoutonFinder $tmp;
