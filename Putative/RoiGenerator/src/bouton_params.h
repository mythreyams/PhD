...
public:
    ...
    {
        std::cout<<"wtf param init"<<std::endl;
        //landmark = new double [3];
        landmark[0] = landmark_coord[0];
        landmark[1] = landmark_coord[1];
        landmark[2] = landmark_coord[2];
        ...
        //std::cout<<landmark[0]<<'\t'<<landmark[1]<<'\t'<<landmark[2]<<'\n';
         std::cout<<"wtf param init end"<<std::endl;
    }
