...
//                      ++edgeCount;
                        ...
                        for(edgeListIt = (*edgeIt)->edgePointCoordinates.begin(); edgeListIt != (*edgeIt)->edgePointCoordinates.end(); ++edgeListIt)
                        {
                                ...
                                for(int i = 0; i < NumOfLandmarks; i++)
                                {
                                    ...
                                    if((BoutonParamsArray[i].nearestPoint[0] == oldCoords[0]) && (BoutonParamsArray[i].nearestPoint[1] == oldCoords[1]) && 
                                        (BoutonParamsArray[i].nearestPoint[2] == oldCoords[2] ))
                                    {
...
//                                         std::cout<<'\t'<<'\t'<<'\t'<<'\t'<<oldCoords[0]<<'\t'<<oldCoords[1]<<'\t'<<oldCoords[2]<<std::endl;
//                                         
...
//                                         
                                        BoutonParamsArray[i].transformed_landmark[0] = newCoords[0];
                                        BoutonParamsArray[i].transformed_landmark[1] = newCoords[1];
                                        BoutonParamsArray[i].transformed_landmark[2] = newCoords[2];
                                        BoutonParamsArray[i].transformed_landmark[3] = BoutonParamsArray[i].nearestPoint[3];
                                    }
