...
int main( int argc, char *argv[] )
{
  ...
  ShapeDetectionFilterType::Pointer ShapeDetector =
  ...
  //  Software Guide : BeginCodeSnippet
  geodesicActiveContour->SetPropagationScaling( atof( argv[9] ) );
  geodesicActiveContour->SetCurvatureScaling( atof( argv[10] ) );
  geodesicActiveContour->SetAdvectionScaling( atof( argv[11] ) );
  
  ShapeDetector->SetPropagationScaling( atof( argv[9] ) );
  ShapeDetector->SetCurvatureScaling( atof( argv[10] ) );
  //geodesicActiveContour->SetAdvectionScaling( atof( argv[11] ) );
  ...
  geodesicActiveContour->SetMaximumRMSError( atof( argv[12] ));
  geodesicActiveContour->SetNumberOfIterations( atof( argv[13] ));
  
  ShapeDetector->SetMaximumRMSError( atof( argv[12] ));
  ShapeDetector->SetNumberOfIterations( atof( argv[13] ));
  ...
  geodesicActiveContour->SetFeatureImage( gradientMagnitude->GetOutput() /*sigmoid->GetOutput()*/ );
  
  ShapeDetector->SetInput(  fastMarching->GetOutput() );
  ShapeDetector->SetFeatureImage( gradientMagnitude->GetOutput() /*sigmoid->GetOutput()*/ );
  ...
  {
    thresholder->SetInput( ShapeDetector->GetOutput() );
  }
  //thresholder->SetInput( ShapeDetector->GetOutput() );
  ...
  const double alivedistance = atof( argv[15] );
  const double outisdeDistance = atof( argv[16] );
  
  const double seedValue = - alivedistance;
  const double aliveseedValue = - initialDistance;
  const double outsideseedValue =  outisdeDistance;
  
  NodeContainer::Pointer seeds = NodeContainer::New();
  NodeContainer::Pointer aliveseeds = NodeContainer::New();
  NodeContainer::Pointer outsideseeds = NodeContainer::New();
  
  seeds->Initialize();
  aliveseeds->Initialize();
  outsideseeds->Initialize();
  
  const int trialposoffset = atof( argv[17] );
  const int outsideposoffset = atof( argv[18] );
  
  InternalImageType::IndexType  seedPosition111;
  seedPosition111[0] = 191-trialposoffset;
  seedPosition111[1] = 430 ;
  
  InternalImageType::IndexType  seedPosition112;
  seedPosition112[0] = 191+trialposoffset;
  seedPosition112[1] = 430 ;
  
  InternalImageType::IndexType  seedPosition1;
  seedPosition1[0] = 191;
  seedPosition1[1] = 430;
  
  InternalImageType::IndexType  seedPosition121;
  seedPosition121[0] = 191-outsideposoffset;
  seedPosition121[1] = 430 ;
  InternalImageType::IndexType  seedPosition122;
  seedPosition122[0] = 191+outsideposoffset;
  seedPosition122[1] = 430 ;
  
  NodeType node1;
  NodeType alivenode11;
  NodeType alivenode12;
  NodeType outsidenode11;
  NodeType outsidenode12;
  
  node1.SetValue( seedValue );
  node1.SetIndex( seedPosition1 );
  seeds->InsertElement( 0, node1 );
  
  alivenode11.SetValue( aliveseedValue );
  alivenode11.SetIndex( seedPosition111 );
  aliveseeds->InsertElement( 0, alivenode11 );
  
  alivenode12.SetValue( aliveseedValue );
  alivenode12.SetIndex( seedPosition112 );
  aliveseeds->InsertElement( 1, alivenode12 );
  
  outsidenode11.SetValue( outsideseedValue );
  outsidenode11.SetIndex( seedPosition121 );
  outsideseeds->InsertElement( 0, outsidenode11 );
  
  outsidenode12.SetValue( outsideseedValue );
  outsidenode12.SetIndex( seedPosition122 );
  outsideseeds->InsertElement( 1, outsidenode12 );

  InternalImageType::IndexType  seedPosition2;
  seedPosition2[0] = 194;
  seedPosition2[1] = 418;
  InternalImageType::IndexType  seedPosition211;
  seedPosition211[0] = 194-trialposoffset;
  seedPosition211[1] = 418;
  InternalImageType::IndexType  seedPosition212;
  seedPosition212[0] = 194+trialposoffset;
  seedPosition212[1] = 418;
  InternalImageType::IndexType  seedPosition221;
  seedPosition221[0] = 194-outsideposoffset;
  seedPosition221[1] = 418;
  InternalImageType::IndexType  seedPosition222;
  seedPosition222[0] = 194+outsideposoffset;
  seedPosition222[1] = 418;
  
  NodeType node2;
  NodeType alivenode21;
  NodeType alivenode22;
  NodeType outsidenode21;
  NodeType outsidenode22;
  
  node2.SetValue( seedValue );
  node2.SetIndex( seedPosition2 );
  seeds->InsertElement( 1, node2 );
  
  alivenode21.SetValue( aliveseedValue );
  alivenode21.SetIndex( seedPosition211 );
  aliveseeds->InsertElement( 2, alivenode21 );
  
  alivenode22.SetValue( aliveseedValue );
  alivenode22.SetIndex( seedPosition212 );
  aliveseeds->InsertElement( 3, alivenode22 );
  
  outsidenode21.SetValue( outsideseedValue );
  outsidenode21.SetIndex( seedPosition221 );
  outsideseeds->InsertElement( 2, outsidenode21 );
  
  outsidenode22.SetValue( outsideseedValue );
  outsidenode22.SetIndex( seedPosition222 );
  outsideseeds->InsertElement( 3, outsidenode22 );
  ...
  NodeType node3;
  NodeType alivenode3;
  NodeType outsidenode3;
  
  node3.SetValue( seedValue );
  node3.SetIndex( seedPosition3 );
  seeds->InsertElement( 2, node3 );
  
  alivenode3.SetValue( aliveseedValue );
  alivenode3.SetIndex( seedPosition3 );
  aliveseeds->InsertElement( 2, alivenode3 );
  
  outsidenode3.SetValue( outsideseedValue );
  outsidenode3.SetIndex( seedPosition3 );
  outsideseeds->InsertElement( 2, outsidenode3 );
  ...
  NodeType node4;
  NodeType alivenode4;
  NodeType outsidenode4;
  
  node4.SetValue( seedValue );
  node4.SetIndex( seedPosition4 );
  seeds->InsertElement( 3, node4 );
  
  alivenode4.SetValue( aliveseedValue );
  alivenode4.SetIndex( seedPosition4 );
  aliveseeds->InsertElement( 3, alivenode4 );
  
  outsidenode4.SetValue( outsideseedValue );
  outsidenode4.SetIndex( seedPosition4 );
  outsideseeds->InsertElement( 3, outsidenode4 );
  ...
  NodeType node5;
  NodeType alivenode5;
  NodeType outsidenode5;
  
  node5.SetValue( seedValue );
  node5.SetIndex( seedPosition5 );
  seeds->InsertElement( 4, node5 );
  
  alivenode5.SetValue( aliveseedValue );
  alivenode5.SetIndex( seedPosition5 );
  aliveseeds->InsertElement( 4, alivenode5 );
  
  outsidenode5.SetValue( outsideseedValue );
  outsidenode5.SetIndex( seedPosition5 );
  outsideseeds->InsertElement( 4, outsidenode5 );
  ...
  NodeType node6;
  NodeType alivenode6;
  NodeType outsidenode6;
  
  node6.SetValue( seedValue );
  node6.SetIndex( seedPosition6 );
  seeds->InsertElement( 5, node6 );
  
  alivenode6.SetValue( aliveseedValue );
  alivenode6.SetIndex( seedPosition6 );
  aliveseeds->InsertElement( 5, alivenode6 );
  
  outsidenode6.SetValue( outsideseedValue );
  outsidenode6.SetIndex( seedPosition6 );
  outsideseeds->InsertElement( 5, outsidenode6 );
  ...
  NodeType node7;
  NodeType alivenode7;
  NodeType outsidenode7;
  
  node7.SetValue( seedValue );
  node7.SetIndex( seedPosition7 );
  seeds->InsertElement( 6, node7 );
  
  alivenode7.SetValue( aliveseedValue );
  alivenode7.SetIndex( seedPosition7 );
  aliveseeds->InsertElement( 6, alivenode7 );
  
  outsidenode7.SetValue( outsideseedValue );
  outsidenode7.SetIndex( seedPosition7 );
  outsideseeds->InsertElement( 6, outsidenode7 );
  ...
  NodeType node8;
  NodeType alivenode8;
  NodeType outsidenode8;
  
  node8.SetValue( seedValue );
  node8.SetIndex( seedPosition8 );
  seeds->InsertElement( 7, node8 );
  
  alivenode8.SetValue( aliveseedValue );
  alivenode8.SetIndex( seedPosition8 );
  aliveseeds->InsertElement( 7, alivenode8 );
  
  outsidenode8.SetValue( outsideseedValue );
  outsidenode8.SetIndex( seedPosition8 );
  outsideseeds->InsertElement( 7, outsidenode8 );
  ...
  //  \code{SetTrialPoints()}.
  //
  fastMarching->SetTrialPoints(  aliveseeds  );
  fastMarching->SetAlivePoints( seeds );
  fastMarching->SetOutsidePoints( outsideseeds);
  ...
  writer4->SetFileName("GeodesicActiveContourImageFilterOutput4_100.png");
