...
mkdir "/home/mythreya/Documents/outputprox/"
chmod 777 "/home/mythreya/Documents/outputprox/"
...
do	
    ...
    # 	
	    ...
	    tmp="${transformated_file} deconvolved_z%03d.png ${OutputName}/S${i}/ProximityDetection 0 ${file} 0 ${mergedFilename} $noImageTest"
	    echo ${tmp}
	    ...
	    do
	      ...
	      ${i} ${roicnt} ${axon_num} ${dend_num} ${OutputName}/S${i}/ProximityDetection/${proxDir}manual_bouton_landmarks.landmarkAscii ${OutputName}/S${i}/ProximityDetection/${proxDir}manual_overlap_landmarks.landmarkAscii"
	      echo $proxtmp	
