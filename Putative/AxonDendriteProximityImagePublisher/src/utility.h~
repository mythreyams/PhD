...
class Utility       
{
 public:
  ...
  static void appendToXls(const char * inputxlsfile, const char * outputxlsfile, std::vector<int> *data, int section_number);
  static bool foundInVector(  std::vector<int> *data, int line_number);
  static void applyTransformationToPoint(double * point, double **given_transformation);
  static bool Match3DPoints(double * point1, double * point2, int precision);
